...
#define MODGEOFILE      "GMODO_npp_d20030125_t0704334_e0705579_b00014_c20090814190100731638_unkn_SCI.h5"  // 0.48 

#define MODGEOGRP       "All_Data/VIIRS-MOD-GEO_All/"
...
int main(void){
	...
	fileID = H5Fopen(MODGEOFILE, H5F_ACC_RDONLY, H5P_DEFAULT);

    /**********************************
	 *  Read in the Latitude dataset  *
     **********************************/

	strcpy(dsetName,MODGEOGRP);
	...
	strcpy(dsetName,MODGEOGRP);
	/*strcat(dsetName,"QF1_VIIRSMODGEO");*/
	...
	strcpy(dsetName,MODGEOGRP);
	/*strcat(dsetName,"QF2_VIIRSMODGEO");*/
